<x-app-layout>
    <div class="max-w-2xl mx-auto px-6 py-8 bg-white text-black min-h-screen">
        <h2 class="text-xl font-normal tracking-tight mb-8 text-black">{{ __('Изменить статус') }}</h2>

        {{ html()->modelForm($taskStatus, 'PATCH', route('task_statuses.update', $taskStatus))->class('space-y-6')->open() }}
